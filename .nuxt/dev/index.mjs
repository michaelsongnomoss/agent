...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/h3/dist/index.mjs';
import { Pinecone } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/@pinecone-database/pinecone/dist/index.js';
import { OpenAI } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/langchain/llms/openai.js';
import { ConversationChain, VectorDBQAChain } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/langchain/chains.js';
import { OpenAIEmbeddings } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/langchain/embeddings/openai.js';
import { PineconeStore } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/langchain/vectorstores/pinecone.js';
import { ChatPromptTemplate } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/langchain/prompts.js';
import { BufferMemory } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/langchain/memory.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/michaelsong/Dev/relevance/agent/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/michaelsong/Dev/relevance/agent/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/michaelsong/Dev/relevance/agent","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/michaelsong/Dev/relevance/agent/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/michaelsong/Dev/relevance/agent/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/michaelsong/Dev/relevance/agent/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/michaelsong/Dev/relevance/agent/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _m5j3q6LANh = (function(nitro) {
...
const _lazy_zkapE9 = () => Promise.resolve().then(function () { return hello$1; });
const _lazy_2tL7Dx = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/hello', handler: _lazy_zkapE9, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_2tL7Dx, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2tL7Dx, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/michaelsong/Dev/relevance/agent/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/michaelsong/Dev/relevance/agent/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
